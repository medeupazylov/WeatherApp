...
SWIFT_CLASS("_TtC10WeatherApp13MainPresenter")
...
@interface MainPresenter (SWIFT_EXTENSION(WeatherApp)) <CLLocationManagerDelegate>
...
@interface MainViewController (SWIFT_EXTENSION(WeatherApp)) <UITableViewDataSource>
- (NSInteger)tableView:(UITableView * _Nonnull)tableView numberOfRowsInSection:(NSInteger)section SWIFT_WARN_UNUSED_RESULT;
- (UITableViewCell * _Nonnull)tableView:(UITableView * _Nonnull)tableView cellForRowAtIndexPath:(NSIndexPath * _Nonnull)indexPath SWIFT_WARN_UNUSED_RESULT;
@end


@interface MainViewController (SWIFT_EXTENSION(WeatherApp)) <UITableViewDelegate>
